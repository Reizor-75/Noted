...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'noted-ml.fly.dev']

CSRF_TRUSTED_ORIGINS = ['https://noted-ml.fly.dev']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main_app.context_processor.set_theme',
                'main_app.context_processor.set_font',
            ],
        },
    },
]
